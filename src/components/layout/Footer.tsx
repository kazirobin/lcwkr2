    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Hanzi Pro Challenge", href: "/hanzi-pro", pro: true },
          { label: "HW & Practice", href: "/hw/hsk1/1", pro: true },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "হানজি প্রো চ্যালেঞ্জ", href: "/hanzi-pro", pro: true },
          { label: "হোমওয়ার্ক ও প্র্যাকটিস", href: "/hw/hsk1/1", pro: true },
