  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        bangla: "আজকের আবহাওয়া খুব ভালো।",
      },
      similar: [
        {
          hanzi: "气候",
    ...
    },
    {
      ...
      example: {
        hanzi: "我去北京住几天。",
        pinyin: "Wǒ qù Běijīng zhù jǐ tiān.",
        english: "I will go to Beijing to stay for a few days.",
        bangla: "আমি বেইজিংয়ে কয়েকদিন থাকতে যাব।",
      },
      similar: [
        {
          hanzi: "日",
    ...
    },
    {
      hanzi: "了",
      pinyin: "le",
      english: "Particle (indicates change or completed action)",
      bangla: "হয়েছে/গেছে (পার্টিকেল)",
      characters: [
        {
          hanzi: "了",
          pinyin: "le",
    ...
    },
    {
      ...
      example: {
        hanzi: "雨很大。",
        pinyin: "Yǔ hěn dà.",
        english: "The rain is heavy.",
        bangla: "বৃষ্টি খুব প্রবল।",
      },
      similar: [
        {
          hanzi: "降水",
    ...
    },
    {
      ...
      example: {
        ...
        english: "Today is a bit cold.",
        bangla: "আজ একটু ঠান্ডা।",
      },
      similar: [
        {
          hanzi: "一点儿",
