  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin:
          "Wǒmen mǎi le dàngāo, zuò le miàntiáor, hái zuò le yú a ròu a shénmede.",
        english:
          "We bought a cake, made noodles, and also made fish, meat, and other dishes.",
      },
      {
        speaker: "Narrator",
      ...
      },
      {
        ...
        pinyin:
          "Míngtiān bù shàngxué, tāmen shuō yào shūshushūfu de shuì yí jiào, ràng wǒmen wǎn diǎnr jiào tāmen qǐchuáng.",
        english:
          "There is no school tomorrow. They said they wanted to have a nice, comfortable sleep and asked us to wake them up a little later.",
      },
      {
        speaker: "Narrator",
  ...
  vocabulary: [
    {
      ...
      similar: [{ hanzi: "床铺", pinyin: "chuángpù", english: "Bed" }],
    },
    {
      hanzi: "舒服",
      pinyin: "shūfu",
